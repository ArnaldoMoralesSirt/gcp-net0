...
data "template_file" "fgt_proxy_2" {
  ...
  vars = {
    ...
    public_ip      = var.fgt-proxy-2-ni_ips["public"]
    ...
    private2_ip   = var.fgt-proxy-2-ni_ips["private2"]
    ...
    private3_ip   = var.fgt-proxy-2-ni_ips["private3"]
    ...
    private4_ip   = var.fgt-proxy-2-ni_ips["private4"]
