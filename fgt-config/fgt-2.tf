...
data "template_file" "fgt_passive" {
  ...
  vars = {
    ...
    private1_ip   = var.fgt-passive-ni_ips["private1"]
    ...
    private2_ip   = var.fgt-passive-ni_ips["private2"]
    ...
    private3_ip   = var.fgt-passive-ni_ips["private3"]
    ...
    private4_ip   = var.fgt-passive-ni_ips["private4"]
    ...
    onpremise_ip   = var.fgt-passive-ni_ips["onpremise"]
